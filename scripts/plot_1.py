...
class gurdyJointPhaseAnalyzer(object):
    ...
    #Individual joint plotting functions
    def plot_head_upperlegM1_joint(self):
        """
        Plot phase diagram for head_upperlegM1_joint
        """
        joint_name = "head_upperlegM1_joint"
    ...
    def plot_head_upperlegM2_joint(self):
        """
        Plot phase diagram for head_upperlegM2_joint
        """
        joint_name = "head_upperlegM2_joint"
        angles = self.joint_data[joint_name]["angles"]
        velocities = self.joint_data[joint_name]["velocities"]
    ...
    def plot_head_upperlegM3_joint(self):
        """
        Plot phase diagram for head_upperlegM3_joint
        """
        joint_name = "head_upperlegM3_joint"
        angles = self.joint_data[joint_name]["angles"]
        velocities = self.joint_data[joint_name]["velocities"]
    ...
    def plot_upperlegM1_lowerlegM1_joint(self):
        """
        Plot phase diagram for upperlegM1_lowerlegM1_joint
        """
        joint_name = "upperlegM1_lowerlegM1_joint"
        angles = self.joint_data[joint_name]["angles"]
        velocities = self.joint_data[joint_name]["velocities"]
    ...
    def plot_upperlegM2_lowerlegM2_joint(self):
        """
        Plot phase diagram for upperlegM2_lowerlegM2_joint
        """
        joint_name = "upperlegM2_lowerlegM2_joint"
        angles = self.joint_data[joint_name]["angles"]
        velocities = self.joint_data[joint_name]["velocities"]
    ...
    def plot_upperlegM3_lowerlegM3_joint(self):
        """
    ...
    def plot_all_individual_joint_diagrams(self):
        """
        Plot individual phase diagrams for all joints
        """
        self.plot_head_upperlegM1_joint()
        # self.plot_head_upperlegM2_joint()
        # self.plot_head_upperlegM3_joint()
        # self.plot_upperlegM1_lowerlegM1_joint()
        # self.plot_upperlegM2_lowerlegM2_joint()
        # self.plot_upperlegM3_lowerlegM3_joint()
        # rospy.loginfo("All individual joint phase diagrams plotted!")

    def plot_phase_diagrams(self):
        """
        Plot phase diagrams for all 6 joints in a single figure
        """
    ...
    def collect_data_and_plot(self):
        ...
        rospy.loginfo("Plotting combined phase diagram...")
        self.plot_phase_diagrams()
        
        rospy.loginfo("Plotting individual joint phase diagrams...")
        self.plot_all_individual_joint_diagrams()
